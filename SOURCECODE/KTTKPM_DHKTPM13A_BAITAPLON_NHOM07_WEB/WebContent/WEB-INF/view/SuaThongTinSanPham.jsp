        ...
        <div class="container shopping-cart">
          <div class="row">
            <div class="col-md-12">
              	...
              	<form action="SuaSanPham_QuanLy?id=<c:out value="${ttsp.maSanPham}"></c:out>" method="post">
					  <div class="form-group">
					    <h4 >Tên sản phẩm :</h4>
					    <input type="text" class="form-control" name="tensanpham" value="${ttsp.tenSanPham}">
					  </div>
					  <div class="form-group">
					    <h4 >Giá:</h4>
					    <input type="text" class="form-control" name="gia" value="${ttsp.gia}">
					  </div>
					  <div class="form-group">
					    <h4 >Số lượng:</h4>
					    <input type="text" class="form-control" name="soluong" value="${ttsp.soLuong}">
					  </div>
					  <div class="form-group">
					    <h4 >Mô tả:</h4>
					  ...
					  <div class="form-group">
					    <h4 >Link ảnh:</h4>
					    <input type="text" class="form-control" name=hinh value="${ttsp.hinh}">
					  </div>
					  <div class="form-group">
					    <h4>Danh muc:</h4>
					  ...
					  <a href="QuanLySanPham">
					  	<button type="button" class="btn btn-primary" >Hũy</button>
					  </a>
