              ...
              <table class="shop-table ">
                ...
                <c:forEach items="${dsdhfalse}" var="dh">
                  <tr>
                    ...
                    <td>
                    	<h5>User:<c:out value="${dh.maNguoiDung.username}"></c:out></h5>
                      	<h5>Họ tên: <c:out value="${dh.maNguoiDung.tenNguoiDung}"></c:out></h5>
                    </td>
                    <td>
                    ...
                    <td>
                    	<form action="QuanLyDonHang?cn=2&user=<c:out value="${dh.maNguoiDung.username}"/>" method="post">
              ...
              <table class="shop-table ">
                ...
                <c:forEach items="${dsdhtrue}" var="dh">
                  <tr>
                    ...
                    <td>
                      <h5><c:out value="${dh.maNguoiDung.username}"></c:out></h5>
                    </td>
                    <td>
