							...
							<tbody>
								<c:forEach items="${listsanpham}" var="sp">
									<tr>
										...
										<td><img src='<c:out value="${sp.hinh}"></c:out>' alt="">
										</td>
										<td><a
											href="SuaSanPham_QuanLy?id=<c:out value="${sp.maSanPham}"/>">
												<input type="button" value="Sửa" class="btn btn-success">
										</a></td>
										<td><a
											href="XoaSanPham_QuanLy?id=<c:out value="${sp.maSanPham}"/>">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="QuanLySanPham?cn=1" method="post">
												...
												<div class="form-group">
													<label>Link ảnh:</label> <input type="text"
														class="form-control" name="hinh">
												</div>
												<div class="form-group">
													<label>Danh muc:</label> <select class="form-control"
														name="madanhmuc">
