	...
	<div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="Home"><img src="images/HinhWebsite/logo.png" alt="Handmade Gift Shop"></a></div>
                  </div>
                  <div class="col-md-10 col-sm-10">
                     <div class="header_top">
                        <div class="row">
                           ...
                           <div class="col-md-6">
 							<strong><p style="color:orange;">Nhóm 07</p></strong>
                           </div>
                           <div class="col-md-3">
                           <%if (session.getAttribute("user") != null) {%>
                           <ul class="usermenu">
                           	<li> 
                           	<div><p style="color: white;">Xin chào :
                     ...
                     <div class="header_bottom">
                        <ul class="option">
                           <li id="search" class="search">
                              <form><input class="search-submit" value="">
